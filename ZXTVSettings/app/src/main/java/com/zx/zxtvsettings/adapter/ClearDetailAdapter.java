...
//            }
    ...
    private class CheckBoxCheckedChange implements CompoundButton.OnCheckedChangeListener {
        ...
        private android.widget.CheckBox cbox;
        private int position = -1;

        public CheckBoxCheckedChange(android.widget.CheckBox cb, int pos) {
            this.cbox = cb;
            this.position = pos;
        }
    ...
    private class CheckBoxClick implements View.OnClickListener {
        ...
        public CheckBoxClick(android.widget.CheckBox cb, int pos) {
            this.cbox = cb;
            this.position = pos;
        }
