...
import com.zx.zx2000tvfileexploer.utils.DensityUtil;
...
public class CommonDialog extends Dialog {
	...
	protected void onCreate(Bundle bundle) {
		...
		if (isTablet(getContext())) {
			int maxWidth = (int) DensityUtil.dip2px(getContext(), 360f);
	...
	public void setMessage(Spanned spanned) {
		...
		tvMessage.setTextSize(TypedValue.COMPLEX_UNIT_SP , 22);
	...
	public void setTitle(CharSequence title) {
		if(title == null) headerVw.setVisibility(View.GONE);
