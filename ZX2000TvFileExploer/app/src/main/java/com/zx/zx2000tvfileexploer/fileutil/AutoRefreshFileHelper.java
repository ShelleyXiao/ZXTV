...
public class AutoRefreshFileHelper {
    ...
    public AutoRefreshFileHelper( Context context, AutoRefreshListener autoRefreshListener, String[] supportSuffix ) throws NullPointerException{
        if( null == context || null == autoRefreshListener || null == supportSuffix ){
            throw new NullPointerException( "null paremter" );
        }
    ...
    private void initAutoRefreshFileHelper( ){
