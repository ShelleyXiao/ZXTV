 ...
 */
public abstract class BaseFileOperationActivity extends BaseStatusBarActivity implements View.OnClickListener{

    protected View mFileViewStatusTitleView;
...
//    }
    ...
    protected void initStatusBarView() {
        mFileViewStatusTitleView = findViewById(R.id.statu);
